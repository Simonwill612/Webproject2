...
<!--
developed By : ManJET Company Web-ecommerce
    -->
"""
...
urlpatterns = [
    ...
    path('admin_dashboard', views.admin_dashboard_view,name='admin-dashboard'),
    ...
    path('my_order', views.my_order_view,name='my-order'),
    ...
    path('customer_address', views.customer_address_view,name='customer-address'),
    path('payment_success', views.payment_success_view,name='payment-success'),
